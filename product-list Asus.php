product-detail.php lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="img/png" href="https://cdn.icon-icons.com/icons2/1880/PNG/512/iconfinder-basket-4341280_120547.png"/>
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="product-list.php">Products List</a></li>
                    <li class="breadcrumb-item active">Product List Asus</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="product-short">
                                                <div class="dropdown">
                                                    <div class="dropdown-toggle" data-toggle="dropdown">สินค้ามาใหม่</div>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="product-detail.php">ASUS G15DH-TH008Tc</a>
                                        <div class="ratting">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="produproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-price">
                                        <h3><span>฿</span>6,000</h3>
                                        <a class="bproduct-detail.php"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus2.png" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="">ASUS ROG Strix GT35 G35CZ-TH002T</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus3.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/IT WEB.gif" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="">ATX (NP) Tsunami Protector Beast 1262*3 Black</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus4.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="">ASUS STRIX GTX 950OC 2GB</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus5.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="">Radeon RX 480 DUAL 4GB</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus6.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="">ASUS ROG Strix Scope RX RED Gaming Keyboard</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus7.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="">MOUSE ASUS ROG GLADIUS II</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com-asus8.jpg" height="390px" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                        ...
                        <div class="col-md-12">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <li class="page-item active"><a class="page-link" href="product-list Asus.php">1</a></li>
                                    <li class="page-item"><a class="page-link" href="prodproduct-detail.php">2</a></li>
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                ...
                                <li><a href="product-list Asus.php">Asus </a><span>(8)</span></li>

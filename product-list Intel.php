                        ...
                        product-detail.php" class="nav-item nav-link">Cart</a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <aproduct-detail.php" class="dropdown-item">Contact Us</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="logo">
                            product-detail.php">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/IT WEB.gif" alt="Logo" height="auto" width="100px">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                        ...
                        <div class="row">
                                            ...
                                            <div class="product-short">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a href="" class="dropdown-item">Pre-Order</a>
                                        ...
                                        <div class="col-md-4">
                                            <div class="product-price-range">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="" class="dropdown-item">฿100 to ฿1,000</a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com8 copy.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com3 copy.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com9 copy.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.php">
                                            <img src="img/com10 copy.jpg" height="390px" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="pproduct-detail.php"><i class="fa fa-cart-plus"></i></a>
                        ...
                        <div class="col-md-12">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <li class="page-item active disabled"><a class="page-link" href="product-list.php">1</a></li>
                                    <li class="page-item"><a class="page-link" href="product-list2.php">2</a></li>
                                    <li class="page-item">
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                <li><a href="proproduct-detail.php">Asus </a><span>(1)</span></li>
